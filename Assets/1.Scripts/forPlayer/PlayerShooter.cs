...
public class PlayerShooter : MonoBehaviour {
    ...
    public static PlayerShooter instance
    {
        get
        {
            if (m_instance == null)
            {
                m_instance = FindObjectOfType<PlayerShooter>();
            }

            return m_instance;
        }
    }
    private static PlayerShooter m_instance; // 싱글톤이 할당될 변수

    public Gun gun; // 사용할 총
    public Transform gunPivot; // 총 배치의 기준점
    public Transform leftHandMount; // 총의 왼쪽 손잡이, 왼손이 위치할 지점
    public Transform rightHandMount; // 총의 오른쪽 손잡이, 오른손이 위치할 지점
    public Transform leftHandRope;
    public Transform rightHandRope;
    public FireGrenade grenade;//수류탄 발사 스크립트
